...
3. run command node generateImageList.js to generate the images.js which contails the paths of the images you added
4. run command node generateVideoList.js to generate the videos.js which contails the paths of the videos you added
